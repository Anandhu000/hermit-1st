...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '02_07_H_E_R_M_I_T_HDPJX68',
    ...
    BOT_NAME: process.env.BOT_NAME || 'ɪ ᴀᴍ ᴢᴏʀᴏ  🗡️',
    ...
    BOT_INFO: process.env.BOT_INFO || 'ɪ ᴀᴍ ᴢᴏʀᴏ  🗡️;~ī.am🍷҉  𝛥𝛮𝛥𝛮𝐷𝛨𝑈 𝛧𝛯𝑅🧋;917356561110;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '~ī.am🍷҉  𝛥𝛮𝛥𝛮𝐷𝛨𝑈 𝛧𝛯𝑅🧋;IG    >>>>🕊️    _.anandx_u_x._;https://i.imgur.com/6LS60t5.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '~ī.am🍷҉  𝛥𝛮𝛥𝛮𝐷𝛨𝑈 𝛧𝛯𝑅🧋;💌🪄' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '917356561110',
       DEBUG: DEBUG
};
